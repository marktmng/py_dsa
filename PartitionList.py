...
class LinkedList:
    ...
    def partition_list(self, x):
        dummy1 = Node(0)  # List for nodes < x
        dummy2 = Node(0)  # List for nodes >= x
        prev1 = dummy1
        prev2 = dummy2
        current = self.head
        ...
        prev1.next = dummy2.next  # Merge both lists
        prev2.next = None         # Important to avoid cycle
        self.head = dummy1.next   # Update the head
